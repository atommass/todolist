...
import 'package:simplenotes/extensions/list/filter.dart';
import 'package:simplenotes/services/crud/crud_exceptions.dart';
...
class NotesService {
  ...
  Future<DatabaseNote> createNote({required DatabaseUser owner}) async {
    ...
    // Make sure user exists in database with correct id
